...
const LandingPage = () => {
  ...
  return (
    ...
    <div className='sm:hidden relative top-0  w-full h-[430px] md:h-screen bg-[url("https://www.pixground.com/wp-content/uploads/2023/10/Maui-Beach-Sunset-4K-Wallpaper-jpg.webp")] bg-no-repeat bg-cover pt-1' >
