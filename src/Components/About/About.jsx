...
const About = () => {
  const { ref, inView } = useInView({
    threshold: 0.50, // Trigger when 25% of the component is visible
  });
  ...
  return (
    <>
      <div
        ...
        data-scroll-section
        data-scroll-speed="-.1"
        className='hidden sm:block w-full pt-20 bg-[#184652] rounded-tl-3xl rounded-tr-3xl z-50  relative'
      >
        ...
        className='flex flex-wrap md:flex-nowrap p-6 md:p-10'>
      ...
      <div className='sm:hidden w-full pt-10 bg-[#184652] z-50  relative'>
        <h1 className='px-10 md:px-20 font-bold text-[8vw] md:text-5xl'>About Us:</h1>
