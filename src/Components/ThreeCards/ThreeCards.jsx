...
const ThreeCards = () => {
  ...
  <>
    ...
    <div className='h-auto sm:hidden py-32 gap-10 justify-center flex flex-wrap bg-zinc-300'>
      
      <div className='bg-red-200 w-[22rem] h-72 mx-[10%] border-2 border-black'>
    ...
    <div className='hidden w-full h-[80vh] bg-[#1b1c27]  sm:flex [from sm to xl]flex-wrap gap-5 items-center px-10'>
      
      <div className='cardcontainer h-[40vh] w-full px-10 xl:px-0 xl:w-1/2'>
