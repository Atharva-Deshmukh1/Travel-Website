...
const ThreeCards = () => {
  ...
  return (
    <>
      ...
      className='hidden w-full max-h-auto min-h-[80vh]  bg-[#1b1c27]  sm:flex sm:max-lg:flex-wrap gap-5 items-center px-10'>
        <div
          className='cardcontainer h-[40vh] w-full px-10 xl:px-0 lg:w-1/2'
        ...
        <div
          className='cardcontainer h-[40vh] flex gap-5 w-full lg:w-1/2'
          
        >
          <div className='card w-72 md:w-1/2 h-full rounded-xl bg-[url("https://media.cntraveler.com/photos/607313c3d1058698d13c31b5/1:1/w_1636,h_1636,c_limit/FamilyCamping-2021-GettyImages-948512452-2.jpg")] bg-no-repeat bg-cover overflow-hidden relative border-2 border-black'>
            <div className="absolute bottom-0  left-0 right-0 p-4 bg-black bg-opacity-50 text-white">CAMPING</div>
          </div>
