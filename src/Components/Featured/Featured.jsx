    ...
    <div className='w-full py-10 bg-slate-600 pb-20'>
      ...
      <div className='px-20 pt-10'>
        <div className='cards w-full flex gap-10'>
          <div className='cardcontainer overflow-hidden relative w-1/2 h-[75vh] '>
            <motion.h1 initial={{y:"100%"}} className='inline-block  absolute z-50 left-full -translate-x-1/2 -translate-y-1/2 top-1/2 tracking-tighter text-6xl'>BRAZIL</motion.h1>
